...
export const Feed = () => {
  ...
  const urlAPI: string = 'https://raw.githubusercontent.com/AiltonRafael/ironbeers/main/db.json'
  ...
  return (
    <Flex direction="column" mx="auto" p={['0', '0', '4']}>
      ...
      <Stack spacing="4" mt="5">
        {loading ? null : Object.values(posts).map((currentPost) => {
          return (
            Object.values(currentPost).map((currentPostInfo) => {
              return (
                <Post
